...
import { Check, Sparkles, ArrowLeft, Sun, Moon, Globe } from 'lucide-react';
...
export default function Plans() {
  ...
  const { data: plans = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Only show free and premium tiers in the public storefront
    ...
    <div className="min-h-screen dark:bg-[#0B1220] bg-[#F8FAFC]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex justify-center gap-5 flex-wrap">
          {isLoading ? (
            // Loading skeleton — same layout as plan cards
            [0, 1].map(i => (
            ...
            plans.map((plan, i) => {
              ...
              return (
                ...
                >
                  ...
                  <Button
                    className={`w-full ${plan.popular ? 'dark:bg-blue-500 dark:hover:bg-blue-600 bg-[#274690] hover:bg-[#1B264F] text-white' : 'dark:bg-white/5 dark:hover:bg-white/10 dark:text-white bg-[#EEF2FA] hover:bg-[#DDE4F0] text-[#274690] font-medium'}`}
                  >
                    {t('plans_select')}
                  </Button>
                </motion.div>
